    ...
    <Accordion defaultActiveKey="0">
      <Accordion.Item eventKey="0">
        ...
        <Accordion.Body>
          ...
          (JavaScript/TypeScript+React+Node.js+Express+MySQL или C#+ASP.NET Core
          MVC+SQL Server) реализовать Web-приложение, позволяющее пользователям
          зарегистрироваться и аутентифицироваться.
          <br />
          ...
          5. Обязательно использование CSS-фреймворка (рекомендация — Bootstrap,
          но можно любой другой). <br />
